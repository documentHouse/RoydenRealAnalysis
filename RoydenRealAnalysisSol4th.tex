...
\[ F = \cup^\infty_{n = 1}(a_n, b_n) \implies  F + y = \cup^\infty_{n = 1}(a_n + y, b_n + y)  \]

Since each of the intervals $(a_n + y, b_n + y)$ is open by the previous comment we have $F +  y$ as a countable union of open sets which is open.
